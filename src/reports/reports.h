...
/**
 * @brief Genera e stampa un report statistico generale di tutte le richieste in memoria.
...
/**
 * @brief Genera e stampa un report operativo dettagliato focalizzato sui flussi di lavoro.
